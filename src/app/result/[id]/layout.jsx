...
const mbtiKeywords = {
  ...
  'INFJ': '옵호자 INFJ, 시니어 INFJ, 중장년 INFJ, 은퇴 후 INFJ, INFJ 성격, INFJ 특징, INFJ 직업, INFJ 상성, INFJ 궁합',
...
const mbtiDescriptions = {
  ...
  'INFJ': '60대+ 시니어 INFJ 옵호자 성격 유형의 상세 분석입니다. 은퇴 후 깊은 통찰력과 의미 있는 인간관계를 추구하는 INFJ의 특징, 강점, 상성 분석을 확인하세요.',
...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    openGraph: {
      ...
      images: [
        {
          url: `/images/mbti-result-${resultId.toLowerCase()}-ko.jpg`,
          width: 1200,
          height: 630,
    ...
    twitter: {
      ...
      title: `시니어 MBTI 결과 - ${resultId} 유형`,
      description: `${resultId} 성격 유형의 상세한 분석 결과입니다. 내 MBTI와 잘 맞는 성향, 잘 맞지 않는 성향을 확인해보세요.`,
      images: [`/images/mbti-result-${resultId.toLowerCase()}-ko.jpg`]
    },
    robots: {
      index: true,
      follow: true,
